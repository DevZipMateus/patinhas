...
const HeroSection = () => {
  return <section id="início" className="relative min-h-screen flex items-start pt-24 md:pt-16 md:items-center bg-gradient-to-r from-pink-50 to-white overflow-hidden">
      {/* Background Pattern */}
          ...
          <AnimatedSection animation="fade-in" delay={300} className="hidden md:block -mt-16">
            <div className="relative">
              ...
              <div className="relative z-10 bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-1 transform transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl">
                <img alt="Cuidado com Pets" className="rounded-2xl w-full h-auto object-cover" src="/lovable-uploads/4b694bc2-2f72-4018-b6d0-2254002edc3d.jpg" />
              </div>
            </div>
          </AnimatedSection>
        </div>
